    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.UUIDField(default=20005406077428)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company_id', models.CharField(default=accounts.models.uniqueid, max_length=30)),
                ...
                ('contact_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contact_person', to=settings.AUTH_USER_MODEL)),
                ('employees', models.ManyToManyField(blank=True, related_name='company_employee', to=settings.AUTH_USER_MODEL)),
