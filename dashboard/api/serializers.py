    ...
    def to_representation(self, instance):
        try:
            ...
            return {
                ...
                "total_qulaity_inspections": total_qulaity_inspections,
                "total_safety_inspections": total_safety_inspections,
                "quality_success_percent":f"{quality_success_percent}%",
                "safety_success_percent":f"{safety_success_percent}%"
            }
